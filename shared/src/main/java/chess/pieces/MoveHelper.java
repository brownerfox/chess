...
public class MoveHelper {
    ...
    public Collection<ChessMove> findBlackPawnForwardMoves (ChessBoard board, ChessPosition myPosition, int[][] moves) {
        Collection<ChessMove> validMoves = new ArrayList<>();
        Collection<ChessPiece.PieceType> potentialPromotions= new ArrayList<ChessPiece.PieceType>(Arrays.asList(BISHOP, ROOK, KNIGHT, QUEEN));
        ChessPiece piece;
        ChessPosition position;
    ...
    public Collection<ChessMove> findBlackPawnAttackingMoves(ChessBoard board, ChessPosition myPosition, int[][] moves) {
        Collection<ChessMove> validMoves = new ArrayList<>();
        Collection<ChessPiece.PieceType> potentialPromotions= new ArrayList<ChessPiece.PieceType>(Arrays.asList(BISHOP, ROOK, KNIGHT, QUEEN));
        ChessPiece piece;
        ChessPosition position;
